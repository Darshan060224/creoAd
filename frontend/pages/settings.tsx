  ...
  return (
    <PageShell title="Settings" subtitle="Tune models, outputs, and infrastructure health.">
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
        <section style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 20, padding: 20 }}>
          <h3 style={{ marginTop: 0 }}>Model selectors</h3>
          <label>Ollama model</label>
          <select style={{ width: '100%', margin: '8px 0 14px', padding: 12, borderRadius: 12, border: '1px solid var(--border)' }}><option>llama3.2:3b</option><option>mistral:7b</option></select>
          <label>TTS backend</label>
          <select style={{ width: '100%', margin: '8px 0 14px', padding: 12, borderRadius: 12, border: '1px solid var(--border)' }}><option>Chatterbox</option><option>Coqui</option></select>
          <label>FFmpeg preset</label>
          <select style={{ width: '100%', marginTop: 8, padding: 12, borderRadius: 12, border: '1px solid var(--border)' }}><option>ultrafast</option><option>veryfast</option><option>fast</option></select>
        </section>
        <section style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 20, padding: 20 }}>
